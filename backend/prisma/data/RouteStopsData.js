const routesData = [
    // === TUYẾN 1 – MORNING ===
    {
        route: { route_id: 1, route_type: "MORNING", start_time: "06:00" },
        stops: [
    ...
    // === TUYẾN 1 – AFTERNOON ===
    {
        route: { route_id: 2, route_type: "AFTERNOON", start_time: "17:00" },
        stops: [
    ...
    // === TUYẾN 2 – MORNING ===
    {
        route: { route_id: 3, route_type: "MORNING", start_time: "06:10" },
        stops: [
    ...
    // === TUYẾN 2 – AFTERNOON ===
    {
        route: { route_id: 4, route_type: "AFTERNOON", start_time: "17:10" },
        stops: [
    ...
    // === TUYẾN 3 – MORNING ===
    {
        route: { route_id: 5, route_type: "MORNING", start_time: "06:15" },
        stops: [
    ...
    // === TUYẾN 3 – AFTERNOON ===
    {
        route: { route_id: 6, route_type: "AFTERNOON", start_time: "17:15" },
        stops: [
    ...
    // === TUYẾN 4 – MORNING ===
    {
        route: { route_id: 7, route_type: "MORNING", start_time: "06:20" },
        stops: [
    ...
    // === TUYẾN 4 – AFTERNOON ===
    {
        route: { route_id: 8, route_type: "AFTERNOON", start_time: "17:20" },
        stops: [
    ...
    // === TUYẾN 5 – MORNING ===
    {
        route: { route_id: 9, route_type: "MORNING", start_time: "06:30" },
        stops: [
    ...
    // === TUYẾN 5 – AFTERNOON ===
    {
        route: { route_id: 10, route_type: "AFTERNOON", start_time: "17:30" },
        stops: [
    ...
    // === TUYẾN 6 – MORNING ===
    {
        route: { route_id: 11, route_type: "MORNING", start_time: "06:40" },
        stops: [
            { stop_id: 29, stop_order: 1, stop_type: "PICKUP" },
            { stop_id: 12, stop_order: 2, stop_type: "PICKUP" },
            { stop_id: 15, stop_order: 3, stop_type: "PICKUP" },
    ...
    // === TUYẾN 6 – AFTERNOON ===
    {
        route: { route_id: 12, route_type: "AFTERNOON", start_time: "17:40" },
        stops: [
    ...
    // === TUYẾN 7 – MORNING ===
    {
        route: { route_id: 13, route_type: "MORNING", start_time: "06:50" },
        stops: [
            { stop_id: 28, stop_order: 1, stop_type: "PICKUP" },
    ...
    // === TUYẾN 7 – AFTERNOON ===
    {
        route: { route_id: 14, route_type: "AFTERNOON", start_time: "17:50" },
        stops: [
