...
const Footer = () => {
  return (
    <footer className="h-[52px] bg-[#E3F1FB] flex items-center justify-between px-6 shadow-inner">
      ...
      <div className="flex space-x-6 text-gray-700 text-lg">
        <Link href="" target="_blank" className="hover:text-gray-900 dark:hover:text-white ms-5">
            <svg
